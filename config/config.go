...
type PromptConfig struct {
	TranslateOnContext string `yaml:"TranslateOnContext"`
	TranslateOrFormat  string `yaml:"TranslateOrFormat"`
...
func Load(path string) *Config {
	...
	if cfg.AI.APIKey == "" {
		log.Fatalf("Warning: AI_API_KEY is not set or using default. AI features will likely fail.")
	}
